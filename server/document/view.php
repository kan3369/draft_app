                ...
                <div class="inner_height">
                    <div class="row_01">
                        ...
                        <div class="doc_num">
                            <div class="num">
                                ...
                                <input class="name" type="text" name="doc_num" value="<?php echo $doc_num; ?>" readonly>
                            </div>
                            <div class="date">
                                <label for="updated_at">文書の日付:</label>
                                <input class="name" type="text" name="updated_at" value="<?php echo $updated_at ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row_02">
                        <div class="draft-name_wrap">
                            <div class="draft_date">
                                ...
                                <input class="name" type="text" name="created_at" value="<?php echo $created_at ?>" readonly>
                            </div>
                            <!-- <div class="name">担当者: </div> -->
                            <div class="maker_name">
                                <p>
                                    <label for="team">部署:</label>
                                    <input class="name" type="text" name="team" value="<?php echo $team ?>" readonly>
                                </p>
                                <p>
                                    <label for="post">役職:</label>
                                    <input class="name" type="text" name="post" value="<?php echo $post ?>" readonly>
                                </p>
                                <p>
                                    <label for="maker">担当者:</label>
                                    <input class="name" type="text" name="maker" value="<?php echo $maker ?>" readonly>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row_05">
                        <div class="title_wrap">
                            ...
                            <textarea class="title_fz" type="text" name="title" rows="1" cols="20" readonly><?php echo $title ?></textarea>
                        </div>
                        <div class="contents_wrap">
                            <label for="contents">内容</label>
                            <!-- <textarea type="text" name="contents"><?php echo $contents ?></textarea> -->
                            <textarea id="message" name="contents" rows="19" cols="300" readonly><?php echo $contents ?></textarea>
                        </div>
                    </div>
                </div>
